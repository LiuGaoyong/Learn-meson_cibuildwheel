...
class TestSipHas24(unittest.TestCase):
    ...
    def test_siphash24_reference(self):
        ...
        self.assertEqual(
            siphash24.siphash24(data, key=key).digest(),
    ...
    def test_siphahs24_reference_chunked(self):
        ...
        for i in range(len(data)):
            for j in range(i, len(data)):
                ...
                self.assertEqual(
                    int.from_bytes(h.digest(), "little"), 0xA129CA6149BE45E5
                )
    ...
    def test_siphash24_buffer_interface(self):
        ...
        self.assertEqual(
            siphash24.siphash24(data).digest(),
            siphash24.siphash24(data.tobytes()).digest(),
        )
